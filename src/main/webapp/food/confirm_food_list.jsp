...
function modify(m_idx, m_name, f_no, f_eattime){
	
	location.href="food_modify_basic.do?m_idx="+m_idx+"&m_name="+m_name+"&f_no="+f_no+"&f_eattime="+f_eattime;
	...
	<table class="table" style="text-align: center;">
		...
		<c:forEach var="food" items="${confirm_food_list}" varStatus="i">
			...
			<tr>
				...
				<td><input class="btn btn-gradient cyan mini" type="button" value="수정" onclick="modify('${food.m_idx}', '${food.m_name}', '${food.f_no}', '${food.f_eattime}')"> 
