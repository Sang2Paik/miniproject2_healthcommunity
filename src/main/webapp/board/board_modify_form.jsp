			   ...
			   <table class="table">
			       ...
			       <tr>
			          ...
			          <td>
			          	  ...
			          	  <br>
			              <input class="form-control btn btn-gradient yellow" type="button" name="b_photo" value="이미지수정" onclick="ajaxFileUpload();">
			          </td>
			       </tr>
			       
			       <tr>
			          <td colspan="2" align="center">
			              <input type="button" class="btn btn-gradient blue"  value="수정하기"
