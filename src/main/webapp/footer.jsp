...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <!-- footer -->
    <footer>
        <div class="container py-4 py-lg-5 w100 footer">
                <p class="mb-0" style="float: left">Copyright © 2024 헬커</p>
                    <span style="float: right" class="list-inline-item"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-facebook">
                    ...
                    </svg>　　<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-instagram">
