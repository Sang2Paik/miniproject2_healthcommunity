...
<body>
	...
	<!-- 20240304 백상희 수정 -->
		<table class="table">
			<tr>
				<td align="left">
					<input type="button" class="nav_btn" value="나의 건강정보" onclick="show_health_info();"> 
					<input type="button" class="nav_btn" value="나의 기본정보" onclick="show_basic_info();">
					<input type="button" class="nav_btn" value="나의 갤러리" onclick="show_board_info();">
				</td>
				<td align="right">
		...
		<div id="my_health_info">
			<table class="table">
				...
				<tr>
					<th class="f16 text-center">일일 활동량</th>
				...
				<tr>
					<th class="f16 text-center">일일 섭취량</th>
